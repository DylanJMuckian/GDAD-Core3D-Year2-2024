...
public abstract class EnemyBase : MonoBehaviour, IDamagable
{
    ...
    protected abstract CodeIdentifier Die();      // Abstract for unique death handling 

    public abstract void Move();                  // Optional: unique movement behaviour

    public void ShowHitEffect()
    {
        // Apply hit effect by changing material color to red
        mat.color = Color.red;
    ...
    {
        // Reset mateirla color to the orignla color
